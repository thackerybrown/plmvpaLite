function mod_est_mvpa(subpar,S)
...
% jbh 7/24/08
% 
% estimates single-trial model specified in ar_mod_spec_mvpa; saves beta
% for that trial to trialBetas directory
% vc 12/06/12
...
if isfield(SPM,'factor')
    if SPM.factor(1).levels > 1
        % don't bother if you've only got 1 level and 1 factor
