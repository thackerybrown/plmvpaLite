function [masked_pat ia ib] = get_masked_pattern_existpat(subj,patname,maskname)

% Returns the pattern's voxels allowed by the mask
% 
% MODIFIED by TIB to handle a pattern which had no original mask (i.e.,
% existpatmat case)
%
