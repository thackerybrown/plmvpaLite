...
defaults.tol = .001;  %changed by JR from default value of .0001 (to speed up computation)
...
% afterwards
for c=1:1 %nConds  % JR edit (6/15/09)
...
scratchpad.logreg.betas(:,2) = -1 * scratchpad.logreg.betas(:,1); % JR edit (6/15/09) Removing redundant 2nd iteration and replacing betas with inverse cuts compute time in half !!
