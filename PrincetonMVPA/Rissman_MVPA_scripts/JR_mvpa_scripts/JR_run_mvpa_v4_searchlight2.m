...
if exist('mvpa_workspace')
    ...
    exp_name = 'PAST';
    roi_file = '/Users/Jesse/fMRI/data/PAST/fMRI/4x4x4/tswmask.img';
    roi_name = 'whole_brain'
    num_TP_per_run = 203;
...
searchlight_path = '/Users/Jesse/fMRI/data/PAST/fMRI/mvpa_results/searchlight_maps_unsmoothed_tsw_mask';
