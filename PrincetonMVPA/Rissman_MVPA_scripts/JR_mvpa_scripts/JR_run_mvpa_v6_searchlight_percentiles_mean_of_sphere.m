...
for b=subj_array
    ...
    searchlight_dir = '/Users/Jesse/fMRI/data/PAST/fMRI/mvpa_results/searchlight_maps/2009/mean_of_sphere_GNB_searchlight_percentile_maps_unsmoothed_NEW_MVPA_MASK';
    ...
    mvpa_workspace = [PAST_dir '/' subj_id '/mvpa/' subj_id '_NEW_MVPA_MASK_wa.mat'];
...
%     class_args.nHidden = 0;  
    ...
    for n = 1: num_results_iter
        ...
        statmap_srch_arg.obj_funct = 'JR_statmap_classify_GNB_inlined_mean_of_sphere';
