function [subj] = JR_extract_weights_only(subj,results,results_IW,varargin)
...
defaults.impmap_name = 'weightmap'; 
...
for i=1:nTimes 
  for j=1:nRuns
    ...
    for k=1:nConds      
      ...
      curWts=results_IW{i}.iterations(j).scratchpad.net.IW{1}(k,:)'; % changed by JR 7/11/08
