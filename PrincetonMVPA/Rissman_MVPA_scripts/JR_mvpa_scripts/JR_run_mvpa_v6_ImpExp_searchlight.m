function []= JR_run_mvpa_v6_ImpExp_ROCs(subj_array, condition1, condition2, which_traintest);
...
for b=subj_array
    ...
    searchlight_dir = '/Users/Jesse/fMRI/data/PAST/fMRI/mvpa_results/searchlight_maps/2009/AUC_GNB_searchlight_maps_unsmoothed_SEPT09_MVPA_MASK';
    ...
    %mvpa_workspace = [PAST_dir '/' subj_id '/mvpa/' subj_id '_whole_brain_no_motor_wa.mat'];
    mvpa_workspace = [PAST_dir '/' subj_id '/mvpa/' subj_id '_SEPT09_MVPA_mask_wa.mat'];
    %mvpa_workspace = [PAST_dir '/' subj_id '/mvpa/' subj_id '_NEW_MVPA_MASK_s8mm_wa.mat'];
    ...
    vol_info.fname = [searchlight_dir '/' subj_id '_' traintest{which_traintest} '_' condnames{1} '_vs_' condnames{2} '_3vox_radius_top_100pct.img'];
    sl_map(included_voxels) = sl_top100_pct_mean;
    spm_write_vol(vol_info, sl_map);
    
    vol_info.fname = [searchlight_dir '/' subj_id '_' traintest{which_traintest} '_' condnames{1} '_vs_' condnames{2} '_3vox_radius_top_75pct.img'];
    sl_map(included_voxels) = sl_top75_pct_mean;
    spm_write_vol(vol_info, sl_map);
    
    vol_info.fname = [searchlight_dir '/' subj_id '_' traintest{which_traintest} '_' condnames{1} '_vs_' condnames{2} '_3vox_radius_top_50pct.img'];
    sl_map(included_voxels) = sl_top50_pct_mean;
    spm_write_vol(vol_info, sl_map);
    
    vol_info.fname = [searchlight_dir '/' subj_id '_' traintest{which_traintest} '_' condnames{1} '_vs_' condnames{2} '_3vox_radius_top_25pct.img'];
    sl_map(included_voxels) = sl_top25_pct_mean;
    spm_write_vol(vol_info, sl_map);
    
    vol_info.fname = [searchlight_dir '/' subj_id '_' traintest{which_traintest} '_' condnames{1} '_vs_' condnames{2} '_3vox_radius_AUC.img'];
    ...
    keep subj_array condition1 condition2 which_traintest
end
