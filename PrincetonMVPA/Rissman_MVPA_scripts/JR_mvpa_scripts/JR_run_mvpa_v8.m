function []= JR_run_mvpa_v8(subj_array, condition1, condition2)
...
for b=subj_array  % allows subject ID #'s to be specified in short format
    ...
    importance_maps_dir=[expt_dir '/mvpa_results/improved_importance_maps/' condition1 '_vs_' condition2 '_balanced_logreg_pen1000_3000vox_fixed'];
    xls_results_data_logs_dir=[expt_dir '/mvpa_results/feature_selection_tests/' condition1 '_vs_' condition2 '_balanced_logreg_pen1000_3000vox_fixed'];
