function []= JR_run_mvpa_v6_logreg_searchlight_mapping(subj_array, condition1, condition2, balance_per_subj_bin);
...
for b=subj_array
    ...
    searchlight_dir = '/Users/Jesse/fMRI/data/PAST/fMRI/mvpa_results/searchlight_maps/2009/logreg_searchlight_maps_unsmoothed_FIXED_AAL';
    ...
    mvpa_workspace = [expt_dir '/' subj_id '/mvpa/' subj_id '_whole_brain_no_motor_s8mm_wa.mat'];
...
%     class_args.nHidden = 0;
    ...
    for n = 1: num_results_iter
        ...
        % Initialize new fields in subject struct to store the single trial
        % activations and classification accuracy values
        
        subj.acts_vector = [];
        subj.corrects_vector = [];      
