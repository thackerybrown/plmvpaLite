function [subj results] = JR_run_mvpa_v6_batch_ROC(subj_arr, cond1, cond2, balance_per_subj_bin)
...
for b=subj_arr
    ...
    importance_maps_dir=[PAST_dir '/mvpa_results/improved_importance_maps/' cond1 '_vs_' cond2 '_' balanced_or_unbal '_NEW'];
    xls_results_data_logs_dir=[PAST_dir '/mvpa_results/xls_results_data_logs/' cond1 '_vs_' cond2 '_' balanced_or_unbal '_NEW'];
    ...
    mvpa_workspace = [PAST_dir '/' subj_id '/mvpa/' subj_id '_merged_AAL_ROIs_4mm_smoothing.mat'];
    ...
    for x = 1: num_results_iter
        ...
        if ~exist('mvpa_workspace')
            ...
            exp_name = 'PAST';
            roi_file = '/Users/Jesse/fMRI/data/PAST/fMRI/4x4x4/merged_AAL_ROIs_FIXED_HOLES.nii';
            roi_name = 'merged_AAL_ROIs_FIXED'
            num_TP_per_run = 203;
            ...
            if flags.save_workspace == 1
                save_cmd = ['save ' mvpa_dir '/' subj_id '_' roi_name '_4mm_smoothing.mat'];
                eval(save_cmd);
            end
        else
        ...
        ROIs_to_use = [39 40 57 58 59 60 61 62 3 4 77 78]
        ...
        for r=2:number_ROI_files+1 % add one b/c whole brain mask is the first mask
