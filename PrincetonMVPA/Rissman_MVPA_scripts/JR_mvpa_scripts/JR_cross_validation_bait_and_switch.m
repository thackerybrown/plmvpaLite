function [subj results] = JR_cross_validation_bait_and_switch(subj,patin,regsname,regsname_switch,selgroup,maskgroup,class_args,varargin)
...
regressors_switch = get_mat(subj,'regressors',regsname_switch);
...
for n=1:nIterations
  ...
  testtargs  = regressors_switch( :,test_idx);
