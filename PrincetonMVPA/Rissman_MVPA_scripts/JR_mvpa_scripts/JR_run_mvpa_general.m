...
for b=subj_array  % allows subject ID #'s to be specified in short format
    ...
    importance_maps_dir=[expt_dir '/mvpa_results/improved_importance_maps/' condition1 '_vs_' condition2 '_top2000_z'];
    xls_results_data_logs_dir=[expt_dir '/mvpa_results/feature_selection_tests/' condition1 '_vs_' condition2 '_top2000_z'];
    ...
    for n = 1: flags.num_results_iter
        ...
        if flags.anova_nVox_thresh ~=0
            subj = JR_feature_select_top_N_vox(subj,'spiral_d_hp_z_condensed','conds','runs_xval','nVox_thresh',flags.anova_nVox_thresh,'statmap_arg',statmap_arg);
