...
function []= JR_run_mvpa_v6_searchlight_percentiles(subj_array, condition1, condition2, balance_per_subj_bin);
...
for b=subj_array
    ...
    vol_info.fname = [searchlight_dir '/' subj_id '_' condnames{1} '_vs_' condnames{2} '_3vox_radius_top_100pct.img'];
    sl_map(included_voxels) = sl_top100_pct_mean;
    spm_write_vol(vol_info, sl_map);
    
    vol_info.fname = [searchlight_dir '/' subj_id '_' condnames{1} '_vs_' condnames{2} '_3vox_radius_top_75pct.img'];
    sl_map(included_voxels) = sl_top75_pct_mean;
    spm_write_vol(vol_info, sl_map);
    
    vol_info.fname = [searchlight_dir '/' subj_id '_' condnames{1} '_vs_' condnames{2} '_3vox_radius_top_50pct.img'];
    sl_map(included_voxels) = sl_top50_pct_mean;
    spm_write_vol(vol_info, sl_map);
    
    vol_info.fname = [searchlight_dir '/' subj_id '_' condnames{1} '_vs_' condnames{2} '_3vox_radius_top_25pct.img'];
    sl_map(included_voxels) = sl_top25_pct_mean;
    spm_write_vol(vol_info, sl_map);
    
    vol_info.fname = [searchlight_dir '/' subj_id '_' condnames{1} '_vs_' condnames{2} '_3vox_radius_AUC.img'];
