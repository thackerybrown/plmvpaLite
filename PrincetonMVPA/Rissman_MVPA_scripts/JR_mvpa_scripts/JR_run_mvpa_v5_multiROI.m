...
r = 0;
for m=[39 40 35 36];  %1:number_ROI_files+1 % add one b/c whole brain mask is the first mask
    r= r+1;
    ...
    for x = 1: num_results_iter
        ...
        classifier_mask = subj.masks{m+1}.name;
    ...
    log.flags = flags;
    log.roi_name{r} = subj.masks{m+1}.name;
