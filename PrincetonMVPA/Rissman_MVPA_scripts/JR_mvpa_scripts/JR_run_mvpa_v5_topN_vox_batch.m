function [subj results] = JR_run_mvpa_v5_batch(subj_arr, cond1, cond2, balance_per_subj_bin, anova_nVox_thresh)
...
for b=subj_arr
    ...
    importance_maps_dir=[PAST_dir '/mvpa_results/improved_importance_maps/' cond1 '_vs_' cond2 '_' balanced_or_unbal '_TR_3_4_top_' num2str(anova_nVox_thresh) '_vox'];
    xls_results_data_logs_dir=[PAST_dir '/mvpa_results/xls_results_data_logs/' cond1 '_vs_' cond2 '_' balanced_or_unbal '_TR_3_4_top_' num2str(anova_nVox_thresh) '_vox'];
    ...
    for q = 1: num_results_iter
        ...
        flags.remove_outlier_trials = 3;  % how many std dev from whole brain mean to exclude as outliers
        ...
        %anova_nVox_thresh = 1;  %p threshold for feature selection ANOVA (1 = DON'T PERFORM ANY FEATURE SELECTION)
    ...
    if flags.generate_importance_maps == 1;
        ...
        if ~exist('if anova_nVox_thresh','var') % NO ANOVA VERSION
            ...
            vol_info.fname = [importance_maps_dir '/' subj_id '_' condnames{1} '_top_' num2str(anova_nVox_thresh) '_vox.img'];
            spm_write_vol(vol_info,impmap1_avg);
            vol_info.fname = [importance_maps_dir '/' subj_id '_' condnames{2} '_top_' num2str(anova_nVox_thresh) '_vox.img'];
