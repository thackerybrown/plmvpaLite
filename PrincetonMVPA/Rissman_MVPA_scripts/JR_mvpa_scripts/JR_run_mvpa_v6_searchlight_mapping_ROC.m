function []= JR_run_mvpa_v6_searchlight_mapping_ROC(subj_array, condition1, condition2, balance_per_subj_bin);
...
for b=subj_array
    ...
    for n = 1: num_results_iter
        ...
        statmap_srch_arg.obj_funct = 'JR_statmap_classify_ROC';
