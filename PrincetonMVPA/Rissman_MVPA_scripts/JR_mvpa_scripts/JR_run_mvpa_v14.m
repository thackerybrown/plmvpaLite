function []= JR_run_mvpa_v14(subj_array, condition1, condition2, nVox,penalty)
...
%     class_args.mode = 'l1';
    ...
    if flags.optimize_penalty_param == 1
        ...
        dir_str = [condition1 '_vs_' condition2 '_' class_args.train_funct_name(6:end) '_L1_pen' num2str(class_args.penalty) '_' num2str(flags.anova_nVox_thresh) 'vox'];
    end
