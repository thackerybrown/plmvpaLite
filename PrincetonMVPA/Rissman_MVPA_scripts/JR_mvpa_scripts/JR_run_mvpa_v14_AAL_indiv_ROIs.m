function []= JR_run_mvpa_v14_AAL_indiv_ROIs(subj_array, condition1, condition2, nVox)
...
%                     end
                    ...
                    log.overall_auc(r,k)=auc_overall;
                    log.overall_acc(r,k)=overall_accuracy;
    ...
    results_array(sub_num,:) = mean(log.overall_auc,2);
...
csvwrite([condition1 '_vs_' condition2 '_AUC_individual_AAL_ROIs.csv'],results_array');
