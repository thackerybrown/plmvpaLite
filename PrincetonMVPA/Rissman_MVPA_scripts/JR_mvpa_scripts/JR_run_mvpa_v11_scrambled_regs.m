function []= JR_run_mvpa_v11_scrambled_regs(subj_array, condition1, condition2, nVox)
...
for b=subj_array  % allows subject ID #'s to be specified in short format
    ...
    if flags.optimize_penalty_param == 1
        ...
        dir_str = ['BAL_RUNS_SCRAMBLED_' condition1 '_vs_' condition2 '_' class_args.train_funct_name(6:end) 'pen' num2str(class_args.penalty) '_' num2str(flags.anova_nVox_thresh) 'vox'];
    end
