function [subj] = JR_feature_select_top_N_vox_iterative(subj,data_patin,regsname,selsgroup,varargin)
...
for n=1:nIterations
  ...
  for t = [25 50 100 250 500 750 1000 1500 2000 3000 4000 6000 8000 12000 16000 18000] 
    % Now, create a new thresholded binary mask from the p-values
    % statmap pattern returned by the anova
    subj = JR_create_top_N_vox_thresh_mask(subj,cur_map_patname,['top_' num2str(t) '_voxels_run_' num2str(n)],t);
    subj = set_objfield(subj,'mask',['top_' num2str(t) '_voxels_run_' num2str(n)],'group_name',['top_' num2str(t) '_voxels']);
  end
