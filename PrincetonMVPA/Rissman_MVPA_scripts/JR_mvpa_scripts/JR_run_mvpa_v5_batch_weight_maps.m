function [subj results] = JR_run_mvpa_v5_batch_weight_maps(subj_arr, cond1, cond2, balance_per_subj_bin)
...
for b=subj_arr
    ...
    importance_maps_dir=[PAST_dir '/mvpa_results/weight_maps/' cond1 '_vs_' cond2 '_' balanced_or_unbal '_TR_3_4'];
    xls_results_data_logs_dir=[PAST_dir '/mvpa_results/xls_results_data_logs/' cond1 '_vs_' cond2 '_' balanced_or_unbal '_TR_3_4'];
    ...
    for x = 1: num_results_iter
        ...
        Objective_old_LC_only = sum(all_regs([3 4],:));
        Objective_new_LC_only = sum(all_regs([8 9],:));
