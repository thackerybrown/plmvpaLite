function [ ] = DEPRECATED_TIB_generate_beta_filenames_ADNI(S)
...
%% binary
  betaidx{1,1} = strcmpi('1',names);
  betaidx{1,2} = strcmpi('2',names);
  
%     betaidx{1,1} = strcmpi('1',names);
%   betaidx{1,2} = strcmpi('3',names);
...
%% binary
% betaidx_tr{1,1} = strcmpi('1',names);
% betaidx_tr{1,2} = strcmpi('2',names);
% 
% betaidx_te{1,1} = strcmpi('100',names);
% betaidx_te{1,2} = strcmpi('200',names);

%one vs three
betaidx_tr{1,1} = strcmpi('1',names);%training set beta indices
betaidx_tr{1,2} = strcmpi('3',names);

betaidx_te{1,1} = strcmpi('100',names);%testing set beta indices
betaidx_te{1,2} = strcmpi('300',names);
