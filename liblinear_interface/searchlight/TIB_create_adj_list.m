function [adj_list scratch] = TIB_create_adj_list(subj, maskid, varargin)

% Creates a list of neighbours for each voxel
%
% [ADJ_LIST] = CREATE_ADJ_LIST(SUBJ,MASKNAME, ...)
%
% Modified by TIB to take in an already prepped mask - useful if mask is
% created in 2-stages, as opposed to being defined by one file (e.g.
% anatomical mask is then trimmed by mask.img file fomr GLM)
%
