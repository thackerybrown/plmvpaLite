<<<<<<< HEAD
function [subj pathfilename] = TIB_move_pattern_to_hd(subj,patname,varargin)
...
if args.memsave == 2
    pathfilenamelogit = [pathfilename '_logits'];
end
...
if args.memsave == 2
    objtemp = get_object(subj, 'pattern', patname);
    logmat = objtemp.created.scratch.multi_acts;
    save(pathfilenamelogit,'logmat');
end
